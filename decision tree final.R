...
library(tidyverse)
## PAP testing decision probabilities
...
## HPV testing decision probabilities
...
## Decision tree function (condition probability calculator)
...
## re-write transition probabilities based on decision tree output
## to use in markov model
